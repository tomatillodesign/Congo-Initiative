...
?>
	...
	<div class="genesis-extender-optionbox-inner-1col">
		<h3 style="border:none; border-bottom:1px solid #F0F0F0; -webkit-box-shadow:none; box-shadow:none;"><?php _e( 'Genesis Extender Settings/Custom Import/Export', 'extender' ); ?> <a href="http://dynamikdocs.cobaltapps.com/article/132-genesis-extender-settings-custom-import-export" class="tooltip-mark" target="_blank">[?]</a></h3>
