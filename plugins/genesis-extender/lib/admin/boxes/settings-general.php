...
<div id="genesis-extender-settings-nav-general-box" class="genesis-extender-all-options">
	...
	<div class="genesis-extender-optionbox-2col-left-wrap">
		...
		<div class="genesis-extender-optionbox-outer-2col">
			<div class="genesis-extender-optionbox-inner-2col">
				<h4><?php _e( 'Genesis Extender URL Protocols', 'dynamik' ); ?></h4>
				
				<div class="bg-box">	
					<p>
						<input type="checkbox" id="genesis-extender-protocol-relative-urls" name="extender[protocol_relative_urls]" value="1" <?php if( checked( 1, genesis_extender_get_settings( 'protocol_relative_urls' ) ) ); ?> /> <?php _e( 'Enable Protocol Relative URLs', 'dynamik' ); ?>
